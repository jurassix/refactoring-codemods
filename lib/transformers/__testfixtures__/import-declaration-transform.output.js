...
var _nextConstants = require('../../nextConstants');
...
var INFO = require('../../nextConstants').INFO;
...
var FeedBack = function (_React$Component) {
  ...
  _createClass(FeedBack, [{
    ...
    value: function render() {
      ...
      } else if (statusCode === _nextConstants.SUCCESS) {
        classes = 'alert alert-success alert-dismissable';
      } else if (statusCode === _nextConstants.ERROR) {
...
FeedBack.propTypes = {
  ...
  statusCode: _react.PropTypes.oneOf([INFO, _nextConstants.SUCCESS, _nextConstants.ERROR])
};
